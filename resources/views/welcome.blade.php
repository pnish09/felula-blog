...
<!-- Grid -->
  ...
  <div class="w3-row w3-padding w3-border" style="	overflow: auto;
">
    ...
    @foreach($post as $record)
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          ...
          <p>{!! Str::words($record->description, 600, ' ...') !!}</p>
          <p class="w3-right"><button class="w3-button w3-black"  id="myBtn"><a href="{{ url('post-single/'.$record->id) }}"><b>Read more..</b></a></button></p>
          <p class="w3-clear"></p>
